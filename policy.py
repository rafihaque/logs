...
save_path = '/home/rhaque2/cs557/final_project/h50/pong_h50.ckpt'
log_path = '/home/rhaque2/cs557/final_project/h50/log_h50.txt'
...
while True:
    ...
    if done:
        ...
        # update timer
        ttime += default_timer() - stime
        
        # print progress console
        if episode_number % 10 == 0:
            print 'ep {}: reward: {}, mean reward: {:3f}'.format(episode_number, reward_sum, running_reward)
            with open(log_path, "a") as f:
                f.write('{},{},{}\n'.format(episode_number,reward_sum,ttime))
        else:
